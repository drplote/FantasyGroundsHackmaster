...
function getPreparedValue()
  return DB.getValue(window.getDatabaseNode(), "memorized_total", 0);
end

function setPreparedValue(nNewValue)
  return DB.setValue(window.getDatabaseNode(), "memorized_total", "number", nNewValue);
end

function getCastValue()
  return DB.getValue(window.getDatabaseNode(), "memorized", 0);
end

function setCastValue(nNewValue)
  return DB.setValue(window.getDatabaseNode(), "memorized", "number", nNewValue);
end
