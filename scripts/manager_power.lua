...
--Debug.console("manager_power.lua","canMemorizeSpell","sCasterType",sCasterType);
...
Debug.console("manager_power.lua","memorizeSpell","nMemorized_Total",nMemorized_Total);      
Debug.console("manager_power.lua","memorizeSpell","sCasterType",sCasterType);      
...
function incrementUse(node)
  ...
  if not bPsionic and not bSpellCasting and sActionType == "cast" then
    ...
    --Debug.console("manager_power.lua","incrementUse","nCast",nCast);    
...
-- Debug.console("manager_power.lua","removeMemorizedSpell","nMemorized_Total",nMemorized_Total);    
...
function getLevelBasedDurationValue(nodeAction)
  ...
  local rActor = ActorManager.getActor("", nodeCaster);
