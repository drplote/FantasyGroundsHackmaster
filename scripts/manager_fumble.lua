...
function getMishapResult(nRollValue)
	...
	elseif nRollValue < 3278 then sResult = "";
	elseif nRollValue < 3323 then sResult = "";
	elseif nRollValue < 4048 then sResult = "";
	elseif nRollValue < 4348 then sResult = "";
	elseif nRollValue < 4448 then sResult = "";
	elseif nRollValue < 4493 then sResult = "";
	elseif nRollValue < 4793 then sResult = "";
	elseif nRollValue < 4943 then sResult = "";
	elseif nRollValue < 4983 then sResult = "";
	elseif nRollValue < 5003 then sResult = "";
	elseif nRollValue < 5303 then sResult = "";
	elseif nRollValue < 5453 then sResult = "";
	elseif nRollValue < 5523 then sResult = "";
	elseif nRollValue < 5553 then sResult = "";
	elseif nRollValue < 5583 then sResult = "";
	elseif nRollValue < 5603 then sResult = "";
	elseif nRollValue < 5653 then sResult = "";
	elseif nRollValue < 5678 then sResult = "";
	elseif nRollValue < 5703 then sResult = "";
	elseif nRollValue < 5712 then sResult = "";
	elseif nRollValue < 5722 then sResult = "";
	elseif nRollValue < 5758 then sResult = "";
	elseif nRollValue < 5780 then sResult = "";
	elseif nRollValue < 5802 then sResult = "";
	elseif nRollValue < 5820 then sResult = "";
	elseif nRollValue < 5833 then sResult = "";
	elseif nRollValue < 5835 then sResult = "";
	elseif nRollValue < 5855 then sResult = "";
	elseif nRollValue < 5870 then sResult = "";
	elseif nRollValue < 5880 then sResult = "";
	elseif nRollValue < 5895 then sResult = "";
	elseif nRollValue < 5945 then sResult = "";
	elseif nRollValue < 5995 then sResult = "";
	elseif nRollValue < 6195 then sResult = "";
	elseif nRollValue < 6285 then sResult = "";
	elseif nRollValue < 6485 then sResult = "";
	elseif nRollValue < 6575 then sResult = "";
	elseif nRollValue < 6775 then sResult = "";
	elseif nRollValue < 6900 then sResult = "";
	elseif nRollValue < 6920 then sResult = "";
	elseif nRollValue < 6929 then sResult = "";
	elseif nRollValue < 6937 then sResult = "";
	elseif nRollValue < 6959 then sResult = "";
	elseif nRollValue < 6969 then sResult = "";
	elseif nRollValue < 6979 then sResult = "";
	elseif nRollValue < 6984 then sResult = "";
	elseif nRollValue < 6999 then sResult = "";
	elseif nRollValue < 7017 then sResult = "";
	elseif nRollValue < 7032 then sResult = "";
	elseif nRollValue < 7038 then sResult = "";
	elseif nRollValue < 7063 then sResult = "";
	elseif nRollValue < 7074 then sResult = "";
	elseif nRollValue < 7078 then sResult = "";
	elseif nRollValue < 7089 then sResult = "";
	elseif nRollValue < 7096 then sResult = "";
	elseif nRollValue < 7186 then sResult = "";
	elseif nRollValue < 7276 then sResult = "";
	elseif nRollValue < 7296 then sResult = "";
	elseif nRollValue < 7306 then sResult = "";
	elseif nRollValue < 7315 then sResult = "";
	elseif nRollValue < 7357 then sResult = "";
	elseif nRollValue < 7369 then sResult = "";
	elseif nRollValue < 7384 then sResult = "";
	elseif nRollValue < 7386 then sResult = "";
	elseif nRollValue < 7398 then sResult = "";
	elseif nRollValue < 7403 then sResult = "";
	elseif nRollValue < 7428 then sResult = "";
	elseif nRollValue < 7448 then sResult = "";
	elseif nRollValue < 7556 then sResult = "";
	elseif nRollValue < 7560 then sResult = "";
	elseif nRollValue < 7580 then sResult = "";
	elseif nRollValue < 7588 then sResult = "";
	elseif nRollValue < 7608 then sResult = "";
	elseif nRollValue < 7618 then sResult = "";
	elseif nRollValue < 7623 then sResult = "";
	elseif nRollValue < 7643 then sResult = "";
	elseif nRollValue < 7653 then sResult = "";
	elseif nRollValue < 7658 then sResult = "";
	elseif nRollValue < 7665 then sResult = "";
	elseif nRollValue < 7685 then sResult = "";
	elseif nRollValue < 7690 then sResult = "";
	elseif nRollValue < 7696 then sResult = "";
	elseif nRollValue < 7699 then sResult = "";
	elseif nRollValue < 7715 then sResult = "";
	elseif nRollValue < 7730 then sResult = "";
	elseif nRollValue < 7740 then sResult = "";
	elseif nRollValue < 7765 then sResult = "";
	elseif nRollValue < 7775 then sResult = "";
	elseif nRollValue < 7805 then sResult = "";
	elseif nRollValue < 7833 then sResult = "";
	elseif nRollValue < 7843 then sResult = "";
	elseif nRollValue < 7857 then sResult = "";
	elseif nRollValue < 7881 then sResult = "";
	elseif nRollValue < 7887 then sResult = "";
	elseif nRollValue < 7896 then sResult = "";
	elseif nRollValue < 7901 then sResult = "";
	elseif nRollValue < 7903 then sResult = "";
	elseif nRollValue < 7909 then sResult = "";
	elseif nRollValue < 7917 then sResult = "";
	elseif nRollValue < 7957 then sResult = "";
	elseif nRollValue < 7989 then sResult = "";
	elseif nRollValue < 8064 then sResult = "";
	elseif nRollValue < 8076 then sResult = "";
	elseif nRollValue < 8092 then sResult = "";
	elseif nRollValue < 8100 then sResult = "";
	elseif nRollValue < 8130 then sResult = "";
	elseif nRollValue < 8200 then sResult = "";
	elseif nRollValue < 8265 then sResult = "";
	elseif nRollValue < 8325 then sResult = "";
	elseif nRollValue < 8380 then sResult = "";
	elseif nRollValue < 8428 then sResult = "";
	elseif nRollValue < 8464 then sResult = "";
	elseif nRollValue < 8488 then sResult = "";
	elseif nRollValue < 8500 then sResult = "";
	elseif nRollValue < 8506 then sResult = "";
	elseif nRollValue < 8531 then sResult = "";
	elseif nRollValue < 8547 then sResult = "";
	elseif nRollValue < 8556 then sResult = "";
	elseif nRollValue < 8570 then sResult = "";
	elseif nRollValue < 8585 then sResult = "";
	elseif nRollValue < 8589 then sResult = "";
	elseif nRollValue < 8592 then sResult = "";
	elseif nRollValue < 8640 then sResult = "";
	elseif nRollValue < 8664 then sResult = "";
	elseif nRollValue < 8676 then sResult = "";
	elseif nRollValue < 8696 then sResult = "";
	elseif nRollValue < 8716 then sResult = "";
	elseif nRollValue < 8736 then sResult = "";
	elseif nRollValue < 8743 then sResult = "";
	elseif nRollValue < 8793 then sResult = "";
	elseif nRollValue < 8798 then sResult = "";
	elseif nRollValue < 8802 then sResult = "";
	elseif nRollValue < 8809 then sResult = "";
	elseif nRollValue < 8814 then sResult = "";
	elseif nRollValue < 8821 then sResult = "";
	elseif nRollValue < 8835 then sResult = "";
	elseif nRollValue < 8847 then sResult = "";
	elseif nRollValue < 8857 then sResult = "";
	elseif nRollValue < 8887 then sResult = "";
	elseif nRollValue < 8896 then sResult = "";
	elseif nRollValue < 8901 then sResult = "";
	elseif nRollValue < 8907 then sResult = "";
	elseif nRollValue < 8920 then sResult = "";
	elseif nRollValue < 8930 then sResult = "";
	elseif nRollValue < 8940 then sResult = "";
	elseif nRollValue < 9040 then sResult = "";
	elseif nRollValue < 9051 then sResult = "";
	elseif nRollValue < 9060 then sResult = "";
	elseif nRollValue < 9075 then sResult = "";
	elseif nRollValue < 9082 then sResult = "";
	elseif nRollValue < 9092 then sResult = "";
	elseif nRollValue < 9102 then sResult = "";
	elseif nRollValue < 9106 then sResult = "";
	elseif nRollValue < 9108 then sResult = "";
	elseif nRollValue < 9115 then sResult = "";
	elseif nRollValue < 9117 then sResult = "";
	elseif nRollValue < 9124 then sResult = "";
	elseif nRollValue < 9129 then sResult = "";
	elseif nRollValue < 9216 then sResult = "";
	elseif nRollValue < 9236 then sResult = "";
	elseif nRollValue < 9246 then sResult = "";
	elseif nRollValue < 9253 then sResult = "";
	elseif nRollValue < 9257 then sResult = "";
	elseif nRollValue < 9261 then sResult = "";
	elseif nRollValue < 9263 then sResult = "";
	elseif nRollValue < 9273 then sResult = "";
	elseif nRollValue < 9278 then sResult = "";
	elseif nRollValue < 9303 then sResult = "";
	elseif nRollValue < 9323 then sResult = "";
	elseif nRollValue < 9359 then sResult = "";
	elseif nRollValue < 9377 then sResult = "";
	elseif nRollValue < 9386 then sResult = "";
	elseif nRollValue < 9406 then sResult = "";
	elseif nRollValue < 9446 then sResult = "";
	elseif nRollValue < 9471 then sResult = "";
	elseif nRollValue < 9485 then sResult = "";
	elseif nRollValue < 9505 then sResult = "";
	elseif nRollValue < 9515 then sResult = "";
	elseif nRollValue < 9520 then sResult = "";
	elseif nRollValue < 9522 then sResult = "";
	elseif nRollValue < 9523 then sResult = "";
	elseif nRollValue < 9548 then sResult = "";
	elseif nRollValue < 9578 then sResult = "";
	elseif nRollValue < 9618 then sResult = "";
	elseif nRollValue < 9642 then sResult = "";
	elseif nRollValue < 9657 then sResult = "";
	elseif nRollValue < 9664 then sResult = "";
	elseif nRollValue < 9689 then sResult = "";
	elseif nRollValue < 9709 then sResult = "";
	elseif nRollValue < 9714 then sResult = "";
	elseif nRollValue < 9724 then sResult = "";
	elseif nRollValue < 9744 then sResult = "";
	elseif nRollValue < 9764 then sResult = "";
	elseif nRollValue < 9774 then sResult = "";
	elseif nRollValue < 9794 then sResult = "";
	elseif nRollValue < 9797 then sResult = "";
	elseif nRollValue < 9799 then sResult = "";
	elseif nRollValue < 9800 then sResult = "";
	elseif nRollValue < 9806 then sResult = "";
	elseif nRollValue < 9815 then sResult = "";
	elseif nRollValue < 9818 then sResult = "";
	elseif nRollValue < 9828 then sResult = "";
	elseif nRollValue < 9833 then sResult = "";
	elseif nRollValue < 9843 then sResult = "";
	elseif nRollValue < 9849 then sResult = "";
	elseif nRollValue < 9859 then sResult = "";
	elseif nRollValue < 9862 then sResult = "";
	elseif nRollValue < 9872 then sResult = "";
	elseif nRollValue < 9874 then sResult = "";
	elseif nRollValue < 9877 then sResult = "";
	elseif nRollValue < 9887 then sResult = "";
	elseif nRollValue < 9894 then sResult = "";
	elseif nRollValue < 9899 then sResult = "";
	elseif nRollValue < 9900 then sResult = "Chokes to death in 1 round";
