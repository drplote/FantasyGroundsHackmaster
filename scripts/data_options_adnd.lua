...
function registerOptions()
  ...
  -- PCs initiative type
  OptionsManager.registerOption2("PCINIT", false, "option_header_combat", "option_label_PCINIT", "option_entry_cycler", 
      { labels = "option_val_group", values = "group", baselabel = "option_val_off", baseval = "off", default = "off" });
