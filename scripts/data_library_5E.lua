...
--    aGMListButtons = { "button_item_armor", "button_item_weapons","button_item_list", "button_item_templates" };
    aGMListButtons = { "button_item_armor", "button_item_weapons","button_item_list_player" };
    aPlayerListButtons = { "button_item_armor_player", "button_item_weapons_player","button_item_list_player" };
  ...
  ["spell"] = {
    ...
    aPlayerListButtons = { "button_spells_arcane_player", "button_spells_school_player","button_spells_divine_player","button_spells_sphere_player" };
    aCustomFilters = {
