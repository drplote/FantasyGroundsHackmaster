...
-- Debug.console("manager_action_turnundead.lua","modRoll","nAddMod",nAddMod);    
    -- if (nEffectCount > 0) then
      -- bEffects = true;
    -- end
    -- rRoll.nMod = rRoll.nMod + nAddMod;
...
-- Debug.console("manager_action_turnundead.lua","modRoll","nAddMod2",nAddMod);    
    -- if (nEffectCount > 0) then
      -- bEffects = true;
    -- end
    -- rRoll.nTarget = rRoll.nTarget + nAddMod;
          ...
          for i=1, #aHDTurn do
            ...
            for nID=1,#aTargets do
              ...
              if (sNodeName ~= nil) then
                ...
                if (sCreatureType:match("undead") ~= nil and nLevel <= aHDTurn[i].nHD and not getAlreadyTurned(aTurnedList,node)) then
