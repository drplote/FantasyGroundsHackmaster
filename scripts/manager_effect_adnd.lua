...
-- Debug.console("manager_effect_adnd.lua","hasEffect","sLabel",sLabel);       
-- Debug.console("manager_effect_adnd.lua","hasEffect","bTargeted",bTargeted);       
-- Debug.console("manager_effect_adnd.lua","hasEffect","aEffectComps",aEffectComps);       
...
-- Debug.console("manager_effect_adnd.lua","hasEffect","nMatch1",nMatch);    
...
--Debug.console("manager_effect_adnd.lua","onEffectTextEncode","rEffect",rEffect);
	local aMessage = {};
...
--Debug.console("manager_effect_adnd.lua","adndOnEffectAddEnd","bNodeSourceIsPC",ActorManager.getType(nodeSource));       
...
Debug.console("manager_effect_adnd.lua","adndOnEffectAddEnd","Dice rolled for effect:",sEffectName,"nRoll=",nRoll);
    end  -- for sDice
...
--Debug.console("manager_effect_adnd.lua","adndOnEffectAddEnd","sFound",sFound);             
          end
          -- -- match for $ARCANE
...
--            sFound = sFound:gsub("%$DIVINE",tostring(PowerManager.getCasterLevelByType(nodeCaster,"divine",bNodeSourceIsPC)));
      ...
      if not sEffectName:match("^DMGX") or not sEffectName:match("^HEALX") then
...
--Debug.console("manager_effect_adnd.lua","getEffectsBonusByType","rActor",rActor);
--Debug.console("manager_effect_adnd.lua","getEffectsBonusByType","aEffectType",aEffectType);
