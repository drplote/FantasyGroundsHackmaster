...
function handleApplyAttack(msgOOB)
  ...
  --applyAttack(rSource, rTarget, (tonumber(msgOOB.nSecret) == 1), msgOOB.sAttackType, msgOOB.sDesc, nTotal, msgOOB.sResults,msgOOB.sAttackLabel);
  --applyAttack(rSource, rTarget, (tonumber(msgOOB.nSecret) == 1), msgOOB.sAttackType, msgOOB.sDesc, nTotal, msgOOB.sDMResults,msgOOB.sWeaponName,msgOOB.sWeaponType,msgOOB.sPCExtendedText);
