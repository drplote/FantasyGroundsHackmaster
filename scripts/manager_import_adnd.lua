...
-- Debug.console("manager_import.lua","contextHighlight","sFindMatch",sFindMatch);
-- Debug.console("manager_import.lua","contextHighlight","sBackwards",sBackwards);
-- Debug.console("manager_import.lua","contextHighlight","sMatch",sMatch);
-- Debug.console("manager_import.lua","contextHighlight","sForwards",sForwards);    
...
Debug.console("manager_import.lua","contextHighlight","sHighlighted-DONE",sHighlighted);      
  return sHighlighted;
end
...
Debug.console("manager_import_adnd.lua","setHD","nTHACO_test",nTHACO_test);            
...
Debug.console("manager_import_adnd.lua","setSomeDefaults","nTHACO-->",nTHACO); 
  if (nTHACO == 999) then
